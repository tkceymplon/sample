...
Nova.booting(function (Vue, router) {
    Vue.component('Gantt', __webpack_require__(2));
});
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().get('/nova-vendor/Gantt/tasks');
                            ...
                            case 2:
                                ...
                                ;
                                allTasks = data.map(function (value) {
                                    var id = value[0].toString();
                                    var startDate = new Date(value[2]);
                                    var endDate = new Date(value[3]);
                                    return [id, value[1], startDate, endDate, null, value[5], value[6].toString()];
                                });
